  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(url('asset/dist/img/ikon.png')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" style="text-transform: capitalize;" class="d-block"><?php echo e(Auth::user()->name); ?></a>
        </div>
      </div>
...
<?php /**PATH /Applications/MAMP/htdocs/sicuti/resources/views/layouts/master.blade.php ENDPATH**/ ?>